...
final class SessionCloseCleanupRuntimeTest {
    ...
    private static Object newReadLoopProtocolTask() throws Exception {
        Class<?> outboundFrameType = Class.forName("io.zmux.SessionRuntime$OutboundFrame");
        Class<?> taskType = Class.forName("io.zmux.SessionRuntime$ReadLoopProtocolTask");
    ...
    void clearSessionCloseStateDropsRetainedCleanupBackings() throws Exception {
        ...
        Class<?> gracefulDeadlineType =
                Class.forName("io.zmux.SessionStopSendingGracefulCoordinator$GracefulDrainDeadline");
