...
final class SessionRuntimeTestSupport {
    ...
    static SessionRuntime newRuntime(DuplexConnection connection, ZmuxConfig config) throws Exception {
        Constructor<SessionRuntime> constructor = SessionRuntime.class.getDeclaredConstructor(DuplexConnection.class, ZmuxConfig.class);
    ...
    static SessionRuntime newReadyRuntime(DuplexConnection connection,
                                          ZmuxConfig config,
                                          long capabilities,
    ...
    static Object newPendingPing(long startedAtNanos, byte[] payload) throws Exception {
        Class<?> type = Class.forName("io.zmux.runtime.SessionRuntime$PendingPing");
