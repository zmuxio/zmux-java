...
public final class Varint62 {
    ...
    public static Decoded decode(byte[] source, int offset, int limit) throws ZmuxException {
        Objects.requireNonNull(source, "source");
        if (offset < 0) {
    ...
    public static Decoded read(FrameCodec.Decoder input) throws IOException {
        Objects.requireNonNull(input, "input");
    ...
    public static long decodeEightByteValue(int first, int b1, int b2, int b3, int b4, int b5, int b6, int b7) {
    ...
    public static boolean isTruncatedVarint(IOException error) {
