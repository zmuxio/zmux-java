...
public final class FrameCodec {
    ...
    public static byte[] readInputBytes(InputStream input, int length) throws IOException {
    ...
    public static void writeFrame(GatheringByteChannel output, Frame frame, Limits limits) throws IOException {
        FrameEnvelopeCodec.writeFrame(output, frame, limits);
    }
    ...
    public static void writePreface(OutputStream output, Preface preface, ZmuxConfig config) throws IOException {
    ...
    public static int checkedLength(long value, ErrorCode code, String operation, String message) throws IOException {
    ...
    public static ZmuxException error(ErrorCode code, String operation, String message) {
        return error(code, operation, message, null);
    }

    public static ZmuxException error(ErrorCode code, String operation, String message, Throwable cause) {
    ...
    public static final class DataPayload {
        ...
        public byte[] appDataBytes() {
            return appData;
        }

        public int appDataOffset() {
